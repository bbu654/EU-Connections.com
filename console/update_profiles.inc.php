...
<tr>
	<? echo write_textfields( "overview" , "Career Summary" , 200 , "(200 characters or fewer)<br /><a href=\"javascript:onClick=alert( 'This paragraph should be a summary of what you do.\nCan use years of experience, perhaps note a significant employer, and describe your capabilities and responsibilities.\nShould be similar to your \\'60-second me.\\'\\nShould be no longer than 40 to 50 words.\\n' )\">Help</a>" , stripslashes( $profile["overview"] ) , "formtype" ) ; ?>
</tr>
<tr>
	<? echo write_textfields( "bullet1" , "Accomplishment 1" , 100 , "(100 characters or fewer)<br /><a href=\"javascript:onClick=alert( 'Up to five brief statements with each preceded by a bullet.\nUse action words where possible with emphasis on key skills, qualifications and accomplishments.\nQuantify accomplishments as much as possible (dollars, percentage, rate of improvement).\nTotal section should be no longer than *150 words.\n' )\">Help</a>" , stripslashes( $profile["bullet1"] ) , "formtype" ) ; ?>
</tr>
<tr>
	<? echo write_textfields( "bullet2" , "Accomplishment 2" , 100 , "(100 characters or fewer)<br /><a href=\"javascript:onClick=alert( 'Up to five brief statements with each preceded by a bullet.\nUse action words where possible with emphasis on key skills, qualifications and accomplishments.\nQuantify accomplishments as much as possible (dollars, percentage, rate of improvement).\nTotal section should be no longer than *150 words.\n' )\">Help</a>" , stripslashes( $profile["bullet2"] ) , "formtype" ) ; ?>
</tr>
<tr>
	<? echo write_textfields( "bullet3" , "Accomplishment 3" , 100 , "(100 characters or fewer)<br /><a href=\"javascript:onClick=alert( 'Up to five brief statements with each preceded by a bullet.\nUse action words where possible with emphasis on key skills, qualifications and accomplishments.\nQuantify accomplishments as much as possible (dollars, percentage, rate of improvement).\nTotal section should be no longer than *150 words.\n' )\">Help</a>" , stripslashes( $profile["bullet3"] ) , "formtype" ) ; ?>
</tr>
<tr>
